...
#ifndef Distillation_Advisor_DTOutputOnPICReportItem_h
#define Distillation_Advisor_DTOutputOnPICReportItem_h
...
namespace dacore {
	...
	class DTOutputOnPICReportItem : public ReportItem {

	public:
		DTOutputOnPICReportItem(ITowerConfig* config, ITowerData* data)
			:ReportItem(config, data){}

		virtual ~DTOutputOnPICReportItem(){}
		...
		virtual double getMin(){
			mMin = mConfig->getControlLimits()->getPressureControllerMin();
			return mMin;
		}

		virtual double getMax(){
			mMax = mConfig->getControlLimits()->getPressureControllerMax();
			return mMax;
		}

		virtual double getCurrent(){
			mCurrent = mData->getOutputOnPIC();
			return mCurrent;
		}
